...
void viewAccidentLog() {
    ...
    if(!fp){ printf("No accident records found!\n"); return; }
...
void adminMenu() {
    ...
    while(1){
        ...
        switch(choice){
            ...
            case 4: printf("\nEnter the id:");scanf("%d",&aid);
                    printf("\nEnter the location:");scanf("%d",&aloc);
                    getchar();
                    printf("\nEnter Operator name:");scanf("%s",aname);
            addAmbulance(aid,aname,aloc);break;
            case 5: printf("Logging out of admin...\n"); return;
